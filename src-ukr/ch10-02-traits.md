...
> Примітка: Трейти подібні до функціоналу, який у багатьох інших мовах називається інтерфейсами, хоча між ними є певні відмінності.
...
Наприклад, припустімо, що у нас є кілька структур, які зберігають різні типи та обсяги тексту: структура NewsArticle, що містить новинну статтю, подану з певного місця, та Tweet, який може містити не більше ніж 280 символів разом із метаданими, що вказують, чи це новий твіт, ретвіт або відповідь на інший твіт.
...
Ми також можемо використовувати синтаксис impl Trait у позиції повернення, щоб повернути значення деякого типу, який реалізує трейд, як показано тут:
